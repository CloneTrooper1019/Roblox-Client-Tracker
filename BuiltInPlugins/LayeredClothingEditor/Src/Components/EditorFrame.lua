--[[
	...
	Required Props:
		...
		string EditingCage: Is the current cage being edited the Inner/Outer cage, or neither. Comes from mapStateToProps
...
Typecheck.wrap(EditorFrame, script)
...
function EditorFrame:render()
	...
	local isEditing = editingCage and not meshPartMode and props.PointData and next(props.PointData)
