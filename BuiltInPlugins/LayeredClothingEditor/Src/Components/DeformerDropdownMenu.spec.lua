	...
	it("should render correctly", function ()
		runComponentTest(
			...
			function(container)
				...
				local dropdownLayout = dropdownContainer.Layout
				local dropdownUIPadding = dropdownContainer.UIPadding
				...
				expect(dropdownLayout).to.be.ok()
				expect(dropdownUIPadding).to.be.ok()
